/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f6cce8ce9b442ca8de2a1fe13d7e1d60)
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./source/index");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CDN_URL" | "DISCORD_TESTERS_GUILD_ID" | "PUBLIC_KEY">> {}
}
